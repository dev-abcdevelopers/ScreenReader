...
object PdfExporter {
    ...
    fun GeneratePolicyPdf(ContextRef: Context, Policies: List<CustomerPolicy>): File {
        ...
        BodyPaint.color = Color.parseColor("#E2E8F0")
        ...
        for (PolicyItem in Policies) {
            ...
            YPos += 24f
            BodyPaint.color = Color.parseColor("#F1F5F9")
